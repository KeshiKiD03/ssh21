...
Para encender el daemon

/usr/sbin/ssh -D

man sshd --> -D enciende el daemon en DETACH

Da error porque no existe el directorio si lo abres en interactivo.

Esto para detach. Por tema de permisos. Al encender servicios, los . init. Crean una tasca previa de inicialización de cosas.

man /run/sshd

/run/sshd --> Para la fase de pre authe del privilegio (Propietario de root, no writeable).

TEMA DE LAS CLAVES 

CLAVE **PRIVADA** Y CLAVE **PÚBLICA**

DESDE EL HOST DEL **USUARIO**
